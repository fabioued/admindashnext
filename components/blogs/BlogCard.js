            ...
            <div className="cus-xl-4 col-lg-4 col-md-12 col-sm-6 col-12 mb-30">
                <div className="card bookmark bookmark--grid">
                    ...
                    <div className="card-body px-15 py-20">
                        <div className="row">
                            <div className="col-md-6">Visibility: <Tag color="cyan" className="my-2">{blog.show_post ? 'visible' : 'hidden'}</Tag></div>
                            <div className="col-md-6">Author: <Tag color="purple" className="my-2">{blog.author}</Tag></div>
                        </div>
