...
const SearchInput = () => {
  ...
  const { loading, link_info_visible, errors } = state;

  const [urlInput, setUrlInput] = useState("");
  const [newShortenedUrl, setNewShortenedUrl] = useState(null);
        ...
        <div className="col-xs-12">
          <div className="input-group input-group-lg">
            ...
            <div className="input-group-btn">
              <button onClick={() => shortenUrl()} className="btn btn-success ml-10 btn-lg px-20">
                {loading && (
                  <span>
                    <svg
                      role="status"
