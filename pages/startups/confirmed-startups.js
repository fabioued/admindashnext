                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                <div className="breadcrumb-main user-member justify-content-sm-between ">
                                    <BreadCrumb title={"Confirmed Startups"} count={startups_count} />
                                </div>
                            </div>
                                                    ...
                                                    return (<tr key={index}>
                                                        ...
                                                        <td className="footable-last-visible">
                                                            <div className="btn-group">
                                                                ...
                                                                <span onClick={() => rejectStartup(startup)} className="media-badge color-white bg-secondary mx-1">Reject</span>
